        ...
        <div className="space-y-4">
          {recommendations.map((recommendation, index) => (
            <CareerCard
              ...
              isSelected={selectedCareer === recommendation.career.id}
              isInDashboard={isInDashboard(recommendation.career.id)}
              isDashboardFull={isDashboardFull() ?? false}
              isAdding={addingToDashboard === recommendation.career.id}
              onToggle={() => toggleCard(index)}
              onSelect={() => handleSelectCareer(recommendation.career.id)}
              onAddToDashboard={() =>
